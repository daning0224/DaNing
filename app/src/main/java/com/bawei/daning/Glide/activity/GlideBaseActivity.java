...
public class GlideBaseActivity extends Activity {
    ...
    private void initData() {
        ...
        String path = Environment.getExternalStorageDirectory() + "/a3.jpg";
        ...
        Glide.with(this).load(file1).thumbnail(0.1f).centerCrop().placeholder(R.mipmap.ic_launcher).into(ivGlide8);
