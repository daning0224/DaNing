...
import com.bawei.daning.Glide.Utils;
...
public class GlideTranformationsAdapter extends RecyclerView.Adapter<GlideTranformationsAdapter.ViewHolder> {
    ...
    public GlideTranformationsAdapter(Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(mContext, R.layout.item_glide_tranformations, null);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        switch (i) {
            ...
            case 1:
                int width1 = Utils.dip2px(mContext, 150.0f);
                int height1 = Utils.dip2px(mContext, 100.0f);
                Glide.with(mContext)
                        .load(R.drawable.check)
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @Bind(R.id.iv_glide_tranformations)
        ImageView image;
